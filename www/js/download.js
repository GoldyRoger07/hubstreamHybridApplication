...
// last update 
function unStyleAllItem(className){
    let itemsToClose = document.querySelectorAll(`.${className}`)
...
// function styleItem(itemName,className){
//         unStyleAllItem(className)
//         let container = document.querySelector(`#${itemName}`)
